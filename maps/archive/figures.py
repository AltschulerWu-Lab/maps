...
def plot_grouped(df, ylab=None, sporadics=True, **kwargs):
    ...
    """
    from .figures_archive import plot_grouped as _legacy_plot_grouped
...
def plot_grouped2(df1, df2, score1, ylab=None, sporadics=True, **kwargs):
    ...
    from .figures_archive import plot_grouped2 as _legacy_plot_grouped2
...
def plot_map_adjustment(df, model=None, X=None, sporadics=False, **kwargs):
    ...
    from .figures_archive import plot_map_adjustment as _legacy_plot_map_adjustment
